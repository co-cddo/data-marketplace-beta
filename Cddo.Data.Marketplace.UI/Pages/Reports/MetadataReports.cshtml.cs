...
{
    public class MetadataReportsModel : PageModel
    {
        public IUserRoleService UserRoleService { get; }
        public IManageOrganisationsService ManageOrganisationsService { get; }
        public MetadataReportsModel(IUserRoleService userRoleService, IManageOrganisationsService manageOrganisationsService)
        {
            UserRoleService = userRoleService;
            ManageOrganisationsService = manageOrganisationsService;
        }

        private readonly string _directoryPath = "Pages/Reports/ReportTemplates/Metadata/";
