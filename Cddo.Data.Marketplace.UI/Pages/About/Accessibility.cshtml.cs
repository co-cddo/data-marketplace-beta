...
namespace Cddo.Data.Marketplace.UI.Pages.About
{
    public class AccessibilityModel : PageModel
    {
        ...
        public AccessibilityModel(AppInsightsLogger logger, IUserRoleService userRoleService)
        {
            _logger = logger;
        ...
        public async void OnGet()
        {
            if (User.Identity.IsAuthenticated)
            {
                ...
                _logger.LogUserEvent(UserEvent.UserPageNavigation, "Accessibility", "CDDO", userEventProperties);
            }
            else
            {
