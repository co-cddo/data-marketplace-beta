document.addEventListener('DOMContentLoaded', function () {
    const formContainer = document.getElementById('keyword-addition');
    ...
    const addButton = document.getElementById('add-another-keyword');
    addButton.addEventListener('click', function () {
        const inputCount = formContainer.querySelectorAll('.govuk-input').length;
        const newInput = document.createElement('div');
        newInput.className = 'govuk-form-group';
        newInput.innerHTML = `
            <label class="govuk-label govuk-visually-hidden" for="keyword-${inputCount}">Keywords</label>
            <div class="govuk-input__wrapper">
                <input class="govuk-input me-2" id="keyword-${inputCount}" name="keyword" type="text">
